  ...
  var collision = function (dt) {
              var fn = function (xs) {
                  ...
                  if (v instanceof Data_Maybe.Just) {
                      ...
                      var v1 = Control_Monad_State.runState(fn2(v.value0.tail))(v.value0.head);
                      return Data_List_Lazy_Types.cons(v1.value1)(fn(v1.value0));
                  };
                  throw new Error("Failed pattern match at Main (line 74, column 17 - line 86, column 28): " + [ v.constructor.name ]);
              };
              return fn;
          };
      ...
      return Data_Functor.map(FRP_Event.functorEvent)(function ($30) {
          return Control_Monad_State.execState(hdl($30));
